    ...
    <ul class="space-y-1">
        ...
        <li>
            <a href="{{ route('people.recommendations') }}"
                ...
                <span class="font-bold text-sm bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-500 transition-all">For You</span>
            </a>
        </li>
        <li>
